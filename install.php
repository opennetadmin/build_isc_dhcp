...
$plugin_name = 'build_isc_dhcp';

// Set a title
$window['title'] = "Build ISC DHCP Install";
...
//
$pmodules = array();
$pmodules['build_dhcpd_conf']['desc'] = 'Build ISC DHCP server configuration';
$pmodules['build_dhcpd_conf']['file'] = "..{$plugindir}/{$plugin_name}.inc.php";
...
$reqfile = $onainstalldir.'/bin/build_dhcpd';
if (file_exists($reqfile)) {
    ...
    $window['html'] .= "<font color=\"orange\">You will want to install the build_dhcpd script on your DHCP server.<br>Download or copy '{$installdir}/build_dhcpd' to /opt/ona/bin/ on your DHCP server.</font><br><br>";
}
